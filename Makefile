...
$(CUSTOM_INCLUDE_PATH):
	@echo "Creating custom include path: $(CUSTOM_INCLUDE_PATH)"
	...
	@echo "Copying files from MacOSX SDK to custom include path"
	...
	@echo "Editing files for platform-specific exclusions"
